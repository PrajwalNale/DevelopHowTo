                                ...
                                <div class="row">
                                    <div class="col-md-4 b-md-r"><a class="dropdown-item text-wrap" href="cs.html">
                                            ...
                                            <p class="my-0 small">The developers' place</p>
                                                ...
                                                <p class="bold my-0">Internet Of Things</p>
                                                <p class="my-0 small">The developers' place</p>
                                        </a><a class="dropdown-item text-wrap" href="cs.html">
                ...
                <div class="shadow bg-1 p-4 rounded">
                    <div class="row gap-y text-center text-md-left">
                        <div class="col-md-4 py-4 px-5 d-flex flex-column b-md-r"><a href="javascript:void(0)" class="color-5">
                                <h4 class="bold mr-3">Engineering & Technology</h4>
                            </a>
                            <p class="mt-4">Develop the products and tools of the future for billions of users.</p><a href="javascript:void(0)" class="d-block d-md-flex align-items-center mt-auto">Enternship/Jobs<i class="fas fa-long-arrow-alt-right ml-3"></i></a>
                        </div>
                        <div class="col-md-4 py-4 px-5 d-flex flex-column b-md-r"><a href="javascript:void(0)" class="color-5">
                                <h4 class="bold mr-3">Sale,Service and support</h4>
                            </a>
                            <p class="mt-4">Equip businesses with the right tools to help them grow.</p><a href="javascript:void(0)" class="d-block d-md-flex align-items-center mt-auto">Enternship/Jobs<i class="fas fa-long-arrow-alt-right ml-3"></i></a>
                        </div>
                        <div class="col-md-4 py-4 px-5 d-flex flex-column"><a href="javascript:void(0)" class="color-5">
                                <h4 class="bold mr-3">People</h4>
                            </a>
                            <p class="mt-4">Find, grow, and support the people who make Google great</p><a href="javascript:void(0)" class="d-block d-md-flex align-items-center mt-auto">Enternship/Jobs<i class="fas fa-long-arrow-alt-right ml-3"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center text-center text-lg-left">
                    <div class="col-12 col-md-7 col-lg-6 mr-lg-auto text-center text-md-left">
                        ...
                        <h2 class="bold">What DevelopHowTo do</h2>
                        <p class="color-2">At DevelopHowTo, work is more than a job—it's a calling. To build. To design. To code. To consult. To think along with clients and sell. To make markets. To invent. To collaborate.
